...
const DOCKER_POSTGRES_SETTINGS = [
  ...
  "POSTGRES_URL=postgres://your_username:your_password@postgres:5432/shadower",
  "POSTGRES_DB=shadower",
...
function copyEnvFile() {
  ...
  // Only create docker/.env if the docker directory exists (not used in Electron builds)
