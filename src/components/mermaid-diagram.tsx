    ...
    debounce(async () => {
      ...
      try {
        ...
        if (
          ...
          errorMessage = `Unsupported diagram type. Mermaid doesn't support "chart" or bar charts. 
...
For bar charts or other chart types, consider using a different visualization tool or converting to a supported Mermaid format.`;
        }
