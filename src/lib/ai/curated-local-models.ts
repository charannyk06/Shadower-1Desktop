...
export const CURATED_LOCAL_MODELS: CuratedModel[] = [
  ...
  },
  {
    ...
    description: "Qwen's vision-language model. Understands images + video. Fast multimodal reasoning.",
    size: "3.1 GB",
    sizeBytes: 3.1 * 1024 * 1024 * 1024,
    contextWindow: 32768,
    toolCalling: true,
    recommended: true,
    useCases: ["Vision", "Multimodal", "Image understanding", "Video analysis", "Tool calling"],
    family: "qwen",
    minRamGB: 6,
    speedTier: "fast",
    isSLM: true,
  ...
  },
  {
    ...
    description: "IBM's latest enterprise model. Excellent reasoning, coding, and tool calling.",
    size: "5.2 GB",
    sizeBytes: 5.2 * 1024 * 1024 * 1024,
    contextWindow: 128000,
    toolCalling: true,
    recommended: true,
    useCases: ["Enterprise", "Reasoning", "Coding", "Tool calling", "RAG"],
    family: "granite",
    minRamGB: 8,
    speedTier: "fast",
  },
