...
import { McpServerCustomizationTable, McpServerTable } from "../schema.sqlite";
...
export const sqliteMcpServerCustomizationRepository: McpServerCustomizationRepository =
  {
